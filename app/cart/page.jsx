  ...
  return (
    ...
    <div className="justify-start items-center gap-12 inline-flex">
        <div className="w-[108px] h-[105px] relative">
            <img className="w-[105px] h-[105px] left-[3px] top-0 absolute rounded-lg" src="/cartPlant.png" />
            <div className="w-[105px] h-[105px] left-0 top-0 absolute rounded-[10px]" />
        </div>
        <div className="w-[150px] text-neutral-400 text-base font-normal font-['Urbanist']">Grobox sdfwef sfwewfw</div>
        <div className="w-[110px] text-neutral-400 text-base font-normal font-['Urbanist']"> 250,000.00</div>
        <div className="w-[130px] h-11 relative">
            ...
            <div className="left-[59px] top-[10px] absolute text-black text-base font-medium font-['Urbanist']">0</div>
        </div>
        <div className="text-black text-base font-normal font-['Urbanist']">250,000.00</div>
