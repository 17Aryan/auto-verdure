  ...
  return (
    ...
    <div className="w-full px-4 md:px-10 pb-[100px] bg-[#FFFCF8] flex flex-col justify-center items-center overflow-hidden">
      ...
      <div className="w-screen flex flex-col-reverse md:flex-row xl:flex-col justify-center items-center overflow-hidden hero-container" >
        <div className="max-w-[361px] xl:max-w-[622px] -mt-[57px] md:mt-[123px] xl:mt-[170px] z-10 flex flex-col justify-center items-start gap-6 content-container" style={{ paddingRight: "12px" }}>
          ...
          <p className="mt-3 xl:mt-[20px] text-sm md:text-base leading-6 xl:text-center font-normal text-secondaryGrayscale hero-description">
